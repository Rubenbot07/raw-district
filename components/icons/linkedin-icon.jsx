export const LinkedinIcon = ({width = 20, height = 20, color = '#000000', strokeWidth = 1}) => {
    return (
        <svg 
            fill={color} height={height} width={width} version="1.1" id="Capa_1" viewBox="0 0 45.959 45.959" 
        >
